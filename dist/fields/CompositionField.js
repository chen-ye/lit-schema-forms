...
`;
const LsfCompositionField = (() => {
  const _classDecorators = [customElement('lsf-composition-field')];
  ...
  const _path_initializers = [];
  const _path_extraInitializers = [];
  let _errors_decorators;
  const _errors_initializers = [];
  const _errors_extraInitializers = [];
  let _widgets_decorators;
  const _widgets_initializers = [];
  const _widgets_extraInitializers = [];
  let _onChange_decorators;
  const _onChange_initializers = [];
  const _onChange_extraInitializers = [];
  let _selectedIndex_decorators;
  const _selectedIndex_initializers = [];
  const _selectedIndex_extraInitializers = [];
  var LsfCompositionField = class extends _classSuper {
    ...
    static {
      ...
      __esDecorate(
        ...
        _errors_initializers,
        _errors_extraInitializers,
      );
      __esDecorate(
        this,
        null,
      ...
      __esDecorate(
        ...
        _onChange_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => 'onChange' in obj,
            get: (obj) => obj.onChange,
            set: (obj, value) => {
              obj.onChange = value;
            },
          },
        ...
        _onChange_initializers,
        _onChange_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        _selectedIndex_decorators,
        {
          kind: 'accessor',
          name: 'selectedIndex',
          static: false,
        ...
        _selectedIndex_initializers,
        _selectedIndex_extraInitializers,
      );
      __esDecorate(
        null,
    ...
    #value_accessor_storage =
      (__runInitializers(this, _schema_extraInitializers), __runInitializers(this, _value_initializers, undefined));
    get value() {
    ...
    #view_accessor_storage =
      (__runInitializers(this, _value_extraInitializers), __runInitializers(this, _view_initializers, {}));
    get view() {
    ...
    #path_accessor_storage =
      (__runInitializers(this, _view_extraInitializers), __runInitializers(this, _path_initializers, ''));
    get path() {
    ...
    #errors_accessor_storage =
      (__runInitializers(this, _path_extraInitializers), __runInitializers(this, _errors_initializers, []));
    get errors() {
      return this.#errors_accessor_storage;
    }
    set errors(value) {
      this.#errors_accessor_storage = value;
    }
    #widgets_accessor_storage =
      (__runInitializers(this, _errors_extraInitializers), __runInitializers(this, _widgets_initializers, {}));
    get widgets() {
    ...
    #onChange_accessor_storage =
      (__runInitializers(this, _widgets_extraInitializers), __runInitializers(this, _onChange_initializers, () => {}));
    get onChange() {
      return this.#onChange_accessor_storage;
    }
    set onChange(value) {
      this.#onChange_accessor_storage = value;
    }
    #selectedIndex_accessor_storage =
      (__runInitializers(this, _onChange_extraInitializers), __runInitializers(this, _selectedIndex_initializers, 0));
    get selectedIndex() {
