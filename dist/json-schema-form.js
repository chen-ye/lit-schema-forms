...
let JsonSchemaForm = (() => {
    ...
    `,
        ...
        #view_accessor_storage = (__runInitializers(this, _schema_extraInitializers), __runInitializers(this, _view_initializers, {}));
        get view() { return this.#view_accessor_storage; }
        set view(value) { this.#view_accessor_storage = value; }
        #data_accessor_storage = (__runInitializers(this, _view_extraInitializers), __runInitializers(this, _data_initializers, {}));
        get data() { return this.#data_accessor_storage; }
        set data(value) { this.#data_accessor_storage = value; }
        #widgets_accessor_storage = (__runInitializers(this, _data_extraInitializers), __runInitializers(this, _widgets_initializers, {}));
        get widgets() { return this.#widgets_accessor_storage; }
        set widgets(value) { this.#widgets_accessor_storage = value; }
        #validationErrors_accessor_storage = (__runInitializers(this, _widgets_extraInitializers), __runInitializers(this, _validationErrors_initializers, []));
        get validationErrors() { return this.#validationErrors_accessor_storage; }
        set validationErrors(value) { this.#validationErrors_accessor_storage = value; }
        ...
        renderFields() {
            ...
            return renderField('', this.schema, this.data, (key, val) => this.handleFieldChange(key, val), this.view || {}, '', // root path
            this.validationErrors, this.widgets);
        }
        render() {
            return html `
